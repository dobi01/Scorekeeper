...
it('renders correct score', () => {
  ...
  const playerScoreRenderedConverted = Number(playerScoreRendered);

  expect(playerScoreRenderedConverted).toEqual(playerScorePassed);
});
...
it('should call onPlayerRemove when remove button is clicked', () => {
  ...
  const removeButton = playerComponent.find('.remove');
